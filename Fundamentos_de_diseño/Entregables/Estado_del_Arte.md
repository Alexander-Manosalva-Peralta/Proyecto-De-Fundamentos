...
| ---------------------------------------------| ---------------------------------------------|
| **Controlar:**
Para dirigir el flujo de agua hacia tanques específicos según el nivel de turbidez detectado. El sistema debe clasificar los niveles de turbidez, pH y coliformes. | **Fiabilidad:** El sistema debe ser altamente confiable, asegurando mediciones precisas y acciones correctas en todo momento.|
| **Monitorear:** El sistema debe proporcionar un monitoreo en tiempo real de los niveles de turbidez y las acciones realizadas, así mismo debe ser accesible a través de la página web. | **Adaptable:**
